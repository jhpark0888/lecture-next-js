...
<ol>
  <li>모듈 소개</li>
  <li>백엔드 추가하기</li>
  <li>옵션 1: 클라이언트 측 데이터 가져오기</li>
  <li>옵션 2: 서버 측 데이터 가져오기</li>
  <li>왜 별도의 백엔드를 사용하나요? 소스에서 직접 가져오세요!</li>
  <li>'로딩 중' 폴백 표시</li>
  <li>전체 애플리케이션을 로컬 데이터 소스(데이터베이스)로 마이그레이션하기</li>
  <li>서스펜스가 있는 세분화된 데이터 가져오기</li>
</ol>
